# pip install flask mysql-connector-python flask-cors flask-mail fpdf schedule
...
def get_data():
    ...
    humidity, temperature, pressure, voltage, current = map(float, data.split(','))
    query = "INSERT INTO sensor_data (humidity, temperature, pressure, voltage, current) VALUES (%s, %s, %s, %s, %s)"
    values = (humidity, temperature, pressure, voltage, current)
